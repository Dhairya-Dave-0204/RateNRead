  ...
  const FEATURED_BOOKS = [
    {
      ...
      author: "Olivie Blake",
      cover: "/api/placeholder/500/650",
      rating: 4.3,
      description:
        "The long-anticipated sequel to dark academic sensation The Atlas Six—the novel you've seen everywhere—is finally here.",
      featured: true,
    },
    {
      id: 102,
      ...
      rating: 4.2,
      description:
        "The twenty-six-year-old Prince Myshkin, following a stay of several years in a Swiss sanatorium, returns to Russia to collect an inheritance.",
      featured: true,
    },
    {
      id: 103,
      ...
      rating: 4.7,
      description:
        "A deeply moving collection of personal essays that reviews different facets of the human-centered planet on a five-star scale.",
      featured: true,
    },
  ];
