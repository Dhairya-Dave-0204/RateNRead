      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-background to-accent-blue">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="mb-16 text-center">
            ...
            >
              Discover a new way to connect with your books through personalized
              tracking, thoughtful organization, and meaningful reflection.
            </motion.p>
          </div>

          {/* Features Display */}
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
            {/* Left side Feature Tabs - Mobile Accordion/Desktop Tabs */}
            <motion.div
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="bg-white rounded-2xl shadow-xl p-6 lg:p-8 relative overflow-hidden h-full min-h-[400px] flex items-center justify-center"
            >
              {activeFeature === 1 && (
                ...
                <div className="w-full max-w-md mx-auto animate-fade-in">
                  <div className="p-6 mb-4 bg-white border border-gray-200 rounded-lg">
                    <div className="mb-4">
                      ...
                      <div className="mb-2 text-sm text-text-mute">
                        by Andy Weir
                      </div>
                      <div className="flex mb-3">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <svg
                            key={star}
                            className="w-5 h-5 text-main-border"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            fill="currentColor"
                          >
                    ...
                    <div className="mb-4">
                      <label className="block mb-1 text-sm font-medium text-tertiary">
                        Your Notes
                      </label>
                      <div className="p-3 text-sm rounded bg-background text-tertiary">
                        An incredible sci-fi story with fascinating scientific
                        concepts. The protagonist's journey and problem-solving
                        approach kept me engaged throughout...
                      </div>
                    </div>
                    <div className="text-right">
                      <button className="text-sm text-main-border hover:underline">
                        Edit Review
                      </button>
                    </div>
                  </div>
                ...
                <div className="w-full max-w-md mx-auto animate-fade-in">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex p-1 rounded-lg bg-background">
                      <button className="px-3 py-1 text-xs text-white rounded bg-main-border">
                        Recent
                      </button>
                      <button className="px-3 py-1 text-xs rounded text-tertiary">
                        Rating
                      </button>
                      <button className="px-3 py-1 text-xs rounded text-tertiary">
                        Title
                        ...
                        <div className="flex">
                          {Array(book.rating)
                            ...
                            .map((_, i) => (
                              <svg
                                key={i}
                                className="w-4 h-4 text-main-border"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                                fill="currentColor"
                              >
                  ...
                  <div className="p-6 bg-white border border-gray-200 rounded-lg">
                    <div className="mb-4">
                      ...
                      <div className="text-sm text-text-mute">
                        Your reading patterns and reflections
                      </div>
                    </div>
                    <div className="mb-6">
                      <div className="h-4 mb-1 rounded-full bg-background">
                        <div
                          className="h-4 rounded-full bg-gradient-to-r from-main-border to-ternary-mint"
                          style={{ width: "65%" }}
                        ></div>
                      </div>
                    ...
                    <div className="text-xs text-center text-text-mute">
                      Track your reading habits over time and discover your
                      literary journey
                    </div>
                  </div>
                </div>
